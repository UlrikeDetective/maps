...
fig, ax = ox.plot_graph(G_highways, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(amenities, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(buildings, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(landuse, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(natural_features, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(leisure, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(shops, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
fig, ax = ox.plot_graph(tourism, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
