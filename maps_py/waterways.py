...
# Plot the graph
fig, ax = ox.plot_graph(Amst, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
ox.graph_to_gdfs(Amst, nodes=False).explore()
...
# Plot the graph
fig, ax = ox.plot_graph(Jak, node_size=0, edge_color="b", bgcolor="white", edge_linewidth=0.2)
ox.graph_to_gdfs(Jak, nodes=False).explore()
